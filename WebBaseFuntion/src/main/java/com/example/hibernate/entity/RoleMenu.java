 ...
 * @Entity
 * 
 * @Table (name = "role_menu") public class RoleMenu {
 * 
 * @Id
 * 
 ...
 * 
 * public RoleMenu(Long role_id, Long menu_id, boolean status) { super();
 * this.role_id = role_id; this.menu_id = menu_id; this.status = status; }
 * 
