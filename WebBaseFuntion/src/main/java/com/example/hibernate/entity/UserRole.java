 ...
 * @Entity
 * 
 * @Table (name = "user_role") public class UserRole {
 * 
 * @Id
 * 
 ...
 * 
 * public UserRole(Long user_id, Long role_id, String status, Date created_at,
 * Date updated_at) { super(); this.user_id = user_id; this.role_id = role_id;
 * this.status = status; this.created_at = created_at; this.updated_at =
 * updated_at; }
 * 
